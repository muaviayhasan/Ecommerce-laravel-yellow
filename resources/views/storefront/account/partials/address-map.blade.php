@if (!empty($mapsEnabled))
    <div class="space-y-2 pb-1">
        <div class="relative">
            <span aria-hidden="true" class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant text-[20px]">search</span>
        ...
        <button type="button" @click="useMyLocation()"
            ...
            <span aria-hidden="true" class="material-symbols-outlined text-[18px]">my_location</span> Use my current location
        </button>
        ...
        <p class="text-label-sm text-on-surface-variant flex items-center gap-1">
            <span aria-hidden="true" class="material-symbols-outlined text-[14px]">info</span> Pick from search, tap “use my location”, or drag the pin to your exact spot.
        </p>
    </div>
@endif
