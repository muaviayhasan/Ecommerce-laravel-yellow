...
@section('content')
    <section class="app-container py-24 text-center">
        <span aria-hidden="true" class="material-symbols-outlined text-7xl text-primary-container mb-4">construction</span>
        ...
        <a href="{{ route('home') }}"
            ...
            <span aria-hidden="true" class="material-symbols-outlined">arrow_back</span> Back to Home
        </a>
    </section>
@endsection
