...
@section('content')
    <div class="bg-surface-container-low py-16 px-4 min-h-[60vh] flex items-center justify-center">
        <div class="w-full max-w-md bg-surface-container-lowest p-8 lg:p-10 rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.06)] border border-outline-variant/40 text-center">
            <span aria-hidden="true" class="material-symbols-outlined text-primary text-[48px]">mark_email_unread</span>
            ...
            <form method="POST" action="{{ route('verification.send') }}" class="mt-6">
                ...
                <button type="submit"
                    ...
                    <span aria-hidden="true" class="material-symbols-outlined text-[20px]">forward_to_inbox</span> Resend verification email
                </button>
            </form>
