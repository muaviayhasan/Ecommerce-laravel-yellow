...
@section('content')
    <div class="mb-6">
        <div class="flex items-center gap-2 text-label-sm mb-1">
            ...
            <span class="text-on-surface-variant font-semibold">Add supplier</span>
        </div>
        <h2 class="text-2xl font-bold text-on-surface">Add supplier</h2>
    </div>
    ...
    <form method="POST" action="{{ route('admin.suppliers.store') }}">
        ...
        <div class="mt-6 flex items-center justify-end gap-3">
            ...
            <button type="submit" class="px-6 py-2.5 bg-primary text-on-primary font-semibold text-sm rounded-lg hover:brightness-110 active:scale-95 transition-all flex items-center gap-2">
                <span class="material-symbols-outlined text-[20px]">check</span> Create supplier
            </button>
        </div>
    </form>
@endsection
