...
@section('content')
    ...
    <x-admin.panel class="!p-0 overflow-hidden">
        <form method="GET" class="js-filters p-4 border-b border-outline-variant/60 flex flex-wrap items-center gap-3">
            ...
            <select name="supplier" class="bg-surface-container-low border border-outline-variant/40 rounded-lg px-3 py-2 text-sm text-on-surface focus:ring-1 focus:ring-primary outline-none cursor-pointer">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                <thead class="text-[10px] font-bold text-outline uppercase tracking-widest border-b border-outline-variant/60">
                    <tr>
                        <th class="px-6 py-3"><x-admin.sort-header column="purchase" label="Purchase" /></th>
                        <th class="px-6 py-3">Supplier</th>
                        <th class="px-6 py-3 text-center"><x-admin.sort-header column="items" label="Items" /></th>
                        <th class="px-6 py-3 text-right"><x-admin.sort-header column="total" label="Total" /></th>
