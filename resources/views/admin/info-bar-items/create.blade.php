...
@section('title', 'New info bar item')
...
@section('content')
    <div>
        ...
        <h2 class="text-2xl font-bold text-on-surface">New info bar item</h2>
    </div>

    <form method="POST" action="{{ route('admin.info-bar-items.store') }}" class="space-y-6">
        @csrf
